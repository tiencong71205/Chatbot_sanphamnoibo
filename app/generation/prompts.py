...
4. Luôn tách thành hai hàng riêng nếu có phần nhận diện:
...
5. Nếu Model trống, ghi "Chưa có dữ liệu"; không lấy Model từ tên file, catalog cũ, alias hoặc suy đoán.
6. Nếu một tiêu chí không có dữ liệu, ghi "Chưa có dữ liệu" vào ô đó.
...
8. Bảng phải là markdown hợp lệ. Hàng tiêu đề và hàng phân cách phải có đúng cùng số cột, ví dụ:
   ...
   `|---|---|---|`
9. Nếu người dùng chỉ nói "so sánh" mà không nêu tiêu chí, chỉ ưu tiên các hàng có bằng chứng rõ trong context: mục đích, mã sản phẩm, Model, nguồn, truyền thông, đầu ra/công suất, kích thước, môi trường, nút bấm, đèn báo, điều khiển, hẹn giờ và tính năng nổi bật. Không tự tạo tiêu chí mơ hồ như "Hệ điện hỗ trợ".
10. Không buộc mọi sản phẩm phải có cùng một tính năng. Với từng ô, chỉ dùng SOURCE thuộc đúng sản phẩm ở cột đó.
