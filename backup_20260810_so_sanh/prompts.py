...
3. Lấy đủ dữ liệu từ TẤT CẢ sản phẩm được hỏi. Không bỏ sót sản phẩm nào.
   Nếu câu hỏi nêu nguồn, giao tiếp/truyền thông hoặc khả năng phát hiện thì phải kiểm tra chunk thông số kỹ thuật của từng sản phẩm trước khi ghi "Chưa có dữ liệu".
