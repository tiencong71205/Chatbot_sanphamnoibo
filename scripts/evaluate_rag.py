"""Evaluate benchmark questions and all-product specification queries."""
import json
import logging
import sys
...
from app.database.bm25_store import BM25Store  # noqa: E402
from app.database.qdrant_store import QdrantStore  # noqa: E402
from app.embeddings.ollama_embedding import OllamaEmbedding  # noqa: E402
from app.generation.ollama_generator import OllamaGenerator  # noqa: E402
...
def run_eval():
    ...
    eval_json_path = ROOT / "data/evaluation/questions.json"
...
"""
    ...
    # Save metrics report
    report_path = ROOT / "data/evaluation/eval_metrics.txt"
    ...
    out_path = ROOT / "data/evaluation/all_products_specification_test.json"
